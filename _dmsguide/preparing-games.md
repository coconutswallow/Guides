...
The world of Toril in the Forgotten Realms is <b>only</b> apart of the broader multiverse that makes up the D&D 5e setting. You are free to run adventures in Wildspace or in other planes of existence; review the relevant material and reach out to fellow DMs and Lore if you have any questions.

You can also run adventures in other worlds and campaign settings, but only for worlds that have an <b>official 5e source material</b>, such as the world of Eberron. Travel to worlds not described in an official 5e sourcebook requires a request in [#dm-requests](https://discord.com/channels/308324031478890497/617831110260424776) to the Lore team. How the PCs can travel to another world is up to your discretion as a DM, but common methods of travel are described in *Tasha’s Cauldron of Everything*.
...
| **T3** | APL 11+ game | Up to # of players. (<span class="role-full-dm">Full DM Only</span>    to predetermine) |
| **T4** | APL 17+ game | Up to # of players. (<span class="role-full-dm">Full DM Only</span> to predetermine) |
| **T1+, T2+, or T3+** | APL 1+, 5+, or 11+ multisession of 3+ games | 1 item slot each (<span class="role-full-dm">Full DM Only</span>). Up to 1 T1+, T2+, and T3+ item per APL 1+, 5+, or 11+ multisession of 3+ games. |
...
- <b>Mythic Gifts</b> function like Supernatural Gifts, but are always Tier S rewards only available to level 20 PCs and can only be awarded by <span class="role-full-dm">Full DMs</span>. A PC can only benefit from one Mythic Gift at a time, choosing which is active after finishing a Long Rest.
