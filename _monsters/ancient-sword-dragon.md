...
| Roll | Trait Name | Description |
|:---:|:---|:---|
| 1 | **Baneful** | The dragon has advantage on attack rolls against a particular kind of creature, and those creatures have disadvantage on saving throws against the dragon's breath weapon. The kind of creature can be a type, race, or group. |
| 2 | **Draining** | Once on each of its turns, the dragon can deal an extra 10 (3d6) necrotic damage when it his a creature with an attack, and the dragon gains temporary hit points equal to the necrotic damage dealt. |
| 3 | **Metamorpic** | The dragon can use a bonus action to gain resistance to either acid, cold, fire, or lightning damage. The resistance lasts until the dragon uses a bonus action to gain another resistance. In addition, the dragon can change the damage type of its attacks and breath weapon to the same type as the chosen resistance. |
...
| Roll | Trait Name | Description |
|:---:|:---|:---|
| 1 | **Commanding** | Once on each of its turns, the dragon can enable one other creature within 60 feet of it to make one weapon attack as a reaction, move up to its speed as a reaction, or gain the benefits of the Dodge action. |
| 2 | **Sharpened** | When the dragon reduces a creature to 0 hit points with an attack, the dragon lops off one of the creature's limbs, with the effect of such loss determined by the DM. If the creature has no limb to sever, the dragon lops off a portion of the creature's body instead. |
...
| 3 | **Reshaping** | The dragon gains a +3 bonus to its attack and damage rolls. The first time the dragon attacks on its turn, it can transfer some or all of the bonus to its Armor Class, instead of using the bonus on any attacks that turn. The adjusted bonuses remain in effect until the start of the dragon's next turn. |
| 4 | **Vorpal** | The dragon's attacks and breath weapon ignore resistance to piercing and slashing damage. If the dragon scores a critical hit against a creature, the target must succeed on a Constitution saving throw or the dragon cuts off the target's head. The target dies if it can't survive without the lost head. A creature that doesn't have or need a head, or has legendary actions, instead takes an extra 27 (6d8) slashing damage. |
...
>
> **AC** 22 (natural armor) **HP** 472 (27d20 + 189) **Speed** 40 ft., fly 80 ft.
>
> | | | MOD | SAVE | | | MOD | SAVE | | | MOD | SAVE |
> |:--|:-:|:----:|:----:|:--|:-:|:----:|:----:|:--|:-:|:----:|:----:|
> |Str| 30| +10| +18|Dex| 1| -5 | +3|Con| 24| +7 | +15|
> |Int| 20| +5 | +13|Wis| 18| +4 | +12|Cha| 22| +6 | +14|
>
...
>
> ***Innate Spellcasting.*** The dragon's innate spellcasting ability is Charisma (spell save DC 25, +17 to hit with spell attacks). It can innately cast the following spells,
...
>
> - Blades rain down on a point on the ground the dragon can see within 120 feet of it in a 10-foot-high, 10-foot-radius cylinder. Each creature in the area must make a DC 15 Dexterity saving throw, taking 21 (6d6) piercing damage on a failed save, or half as much damage on a successful one.
>
...
>
> - Blades brought within 1 mile of the dragon's lair sharpen themselves and never dull while they remain in the area. The dragon can hear up to 30 feet through any magical, bladed weapon within 1 mile of the dragon's lair.
>
