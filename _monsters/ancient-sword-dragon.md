...
Sword dragons are a powerful and exceedingly rare variant of dragons, spawned from dragons hoarding vast quantities of magical swords. Such dragons don't share their parents' traits, and are often abandoned after they show their appetite for consuming valuable weaponry.  
  ...
  *d4 Young Sword Dragon Trait*
  ...
  - 2 **Draining**. Once on each of its turns, the dragon can deal an extra 10 (3d6) necrotic damage when it his a creature with an attack, and the dragon gains
  temporary hit points equal to the necrotic damage dealt.
  - 3 **Metamorpic**. The dragon can use a bonus action to gain resistance to either acid, cold, fire, or lightning damage. The resistance lasts until the dragon uses a
  bonus action to gain another resistance. In addition, the dragon can change the damage type of its attacks and breath weapon to the same type as the chosen
  resistance. 
