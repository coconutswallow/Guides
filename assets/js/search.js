(function() {
  ...
  fetch(BASE_URL + '/search.json') 
    ...
    .catch(error => {
      ...
      results.innerHTML = '<p>Search functionality is temporarily unavailable. (Check search.json file and baseurl config)</p>';
  ...
  function runSearch() {
    ...
    if (searchResults.length > 0) {
      ...
      searchResults.forEach(function (res) {
        ...
        // The URL reference is already correct because Jekyll's Liquid generated absolute_url in search.json
